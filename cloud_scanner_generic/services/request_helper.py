...
class RequestHelper:
    """
    Http request helper uses underlying Session object to pool http connections
    """
    _session: Session = None
    @staticmethod
    def post(url, **kwargs) -> Response:
        """
        Creates a Session object if it does not already exist and performs an Http post on the object
